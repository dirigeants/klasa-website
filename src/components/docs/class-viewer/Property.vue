	...
	<div :id="`doc-for-${scrollTo}`" class="card">
			...
			<nav class="card-header-title level is-marginless">
				<div class="level-left">
					<div class="level-item has-text-left">
						<span v-if="prop.scope === 'static'">
							<span class="tag is-primary" title="This property is on the class constructor function, not instances.">
								Static
							</span>&nbsp;
						</span>
						<span v-if="prop.readonly">
							<span class="tag is-success" title="This property cannot be modified.">
								Read-only
							</span>&nbsp;
						</span>
						<span v-if="prop.deprecated">
							<span class="tag is-danger"	title="This property is deprecated, and may be removed in a future version.">
								Deprecated
							</span>&nbsp;
						</span>
						<span v-if="prop.access === 'private'">
							<span class="tag is-warning" title="This property is private, and may change or be removed at any time.">
								Private
							</span>&nbsp;
						</span>
					</div>
		...
		<footer class="card-footer">
			<p class="card-footer-item">
				<span>
					<strong>Type:</strong>
					<span v-for="(type, index) of prop.type" :key="index">
						<types :names="type" :nullable="prop.nullable" :docs="docs" />
						<span v-if="index < prop.type.length - 1">
							|
						</span>
					</span>
				</span>
